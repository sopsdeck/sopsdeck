...
3. **What to implement next** — [build.md](../.scratch/sopsdeck-product/build.md). Phase status plus ready tickets 19–21.
...
| `./scripts/demo`   | Product screenshots into `docs/assets/`                 |
