...
1. Incomplete tracer-bullet phases in issue 15 (MCP, signed macOS release). Request PR / re-encrypt PR still open on recipients. Fake GitHub PUTs are not Libsodium-sealed. [31](issues/31-deferred-product-ideas.md) is backlog (clipboard/paste path ride with 12/05; OpenBao needs spec).
